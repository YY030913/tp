...
- Internal Hubot naming clarification caoliao:hubot -> caoliao:internal-hubot RocketBot -> InternalHubot RocketBot_Name -> InternalHubot_Username
...
- Simplify and fix ADMIN_EMAIL verification regex. Fixes CaoLiao/CaoLiao#2841 (#2890)
...
- Close #2696 CaoLiao hijacking Firefox shortcut
...
- Use CaoLiao Logger as SyncedCron logger
...
- Expose Assets methods via CaoLiao.Assets
...
- Expose emoji picker in CaoLiao namespace
...
- Improved sidebar overlay - should fix CaoLiao/CaoLiao.Cordova#15
...
- Switched CAS configuration from Meteor.settings to CaoLiao.settings.
...
- Use the CaoLiao.Info.version on headers
...
- Fixed trying to read build from CaoLiao.Info when it is not available.
...
- Add i18n to caoliao-ui-flextab package, with default strings for file deletion dialogue
...
- Closes #2078; ObserveChanges on caoliao_room Not Using Oplog
...
- Detect if system is runing GM or IM, add info to CaoLiao.Info and …
...
- Mover caoliao.info into caoliao:lib
...
- Allow arrays of keys in CaoLiao.settings.onload
