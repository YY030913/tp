CaoLiao.Migrations.add({
	version: 53,
	up: function() {
		CaoLiao.models.Settings.update({ _id: 'Email_Header', value: '' }, {
			$set: {
		...
		CaoLiao.models.Settings.update({ _id: 'Email_Footer', value: '' }, {
			$set: {
				value: '</td></tr></table></td></tr><tr><td border="0" cellspacing="0" cellpadding="0" width="100%" style="font-family: Helvetica,Arial,sans-serif; max-width: 800px; margin: 0 auto; padding: 1.5em; text-align: center; font-size: 8pt; color: #999;">Powered by <a href="https://caoliao" target="_blank">CaoLiao</a></td></tr></table></td></tr></table>'
			}
		});
	}
});
