...
usernameIsAvaliable = (username) ->
	...
	return not CaoLiao.models.Users.findOneByUsername({$regex : new RegExp("^" + username + "$", "i") })
...
@generateSuggestion = (user) ->
	...
	if CaoLiao.settings.get 'UTF8_Names_Slugify'
	...
	return undefined
CaoLiao.generateUsernameSuggestion = generateSuggestion
