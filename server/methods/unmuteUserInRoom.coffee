Meteor.methods
	unmuteUserInRoom: (data) ->
		...
		unmutedUser = CaoLiao.models.Users.findOneByUsername data.username

		CaoLiao.models.Rooms.unmuteUsernameByRoomId data.rid, unmutedUser.username

		fromUser = CaoLiao.models.Users.findOneById fromId
		CaoLiao.models.Messages.createUserUnmutedWithRoomIdAndUser data.rid, unmutedUser,
			u:
				_id: fromUser._id
