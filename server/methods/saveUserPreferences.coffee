	...
	saveUserPreferences: (settings) ->
		if Meteor.userId()
			...
			if settings.language?
				CaoLiao.models.Users.setLanguage Meteor.userId(), settings.language

			if settings.location?
				CaoLiao.models.Users.setLocation Meteor.userId(), settings.location

			if settings.shortCountry?
				CaoLiao.models.Users.setShortCountry Meteor.userId(), settings.shortCountry
			...
			CaoLiao.models.Users.setPreferences Meteor.userId(), preferences
