...
const pkgdef :Spk.PackageDefinition = (
	...
	manifest = (
		...
		metadata = (
			icons = (
				appGrid = (svg = embed "caoliao-128.svg"),
				grain = (svg = embed "caoliao-24.svg"),
				market = (svg = embed "caoliao-150.svg"),
			),

			website = "https://caoliao",
			codeUrl = "https://github.com/CaoLiao/CaoLiao",
			license = (openSource = mit),
			categories = [communications, productivity, office, social, developerTools],

			author = (
				contactEmail = "team@caoliao",
				pgpSignature = embed "pgp-signature",
				upstreamAuthor = "CaoLiao",
			),
