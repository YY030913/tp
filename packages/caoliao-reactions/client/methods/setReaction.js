Meteor.methods({
	setReaction(reaction, messageId) {
		...
		let message = CaoLiao.models.Messages.findOne({ _id: messageId });
		...
		if (message.reactions && message.reactions[reaction] && message.reactions[reaction].usernames.indexOf(user.username) !== -1) {
			...
			if (_.isEmpty(message.reactions)) {
				...
				CaoLiao.models.Messages.unsetReactions(messageId);
			} else {
				CaoLiao.models.Messages.setReactions(messageId, message.reactions);
			}
		} else {
