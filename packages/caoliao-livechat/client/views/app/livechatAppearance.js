Template.livechatAppearance.helpers({
	...
	emailOffline() {
		return CaoLiao.settings.get('Livechat_offline_email');
	},
	sampleColor() {
...
Template.livechatAppearance.onCreated(function() {
	...
	this.autorun(() => {
		this.title.set(CaoLiao.settings.get('Livechat_title'));
	});
	this.autorun(() => {
		this.color.set(CaoLiao.settings.get('Livechat_title_color'));
	});
	this.autorun(() => {
		this.offlineMessage.set(CaoLiao.settings.get('Livechat_offline_message'));
	});
	this.autorun(() => {
		this.titleOffline.set(CaoLiao.settings.get('Livechat_offline_title'));
	});
	this.autorun(() => {
		this.colorOffline.set(CaoLiao.settings.get('Livechat_offline_title_color'));
	});
});
...
Template.livechatAppearance.events({
	...
	'click .reset-settings'(e, instance) {
		...
		instance.title.set(CaoLiao.settings.get('Livechat_title'));
		instance.color.set(CaoLiao.settings.get('Livechat_title_color'));
		instance.offlineMessage.set(CaoLiao.settings.get('Livechat_offline_message'));
		instance.titleOffline.set(CaoLiao.settings.get('Livechat_offline_title'));
		instance.colorOffline.set(CaoLiao.settings.get('Livechat_offline_title_color'));
	...
	'submit .rocket-form'(e, instance) {
		...
		CaoLiao.settings.batchSet(settings, (err/*, success*/) => {
			if (err) {
