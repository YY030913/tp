 ...
 */
class LivechatDepartmentAgents extends CaoLiao.models._Base {
	constructor() {
		super();
	...
	getNextAgentForDepartment(departmentId) {
		...
		var onlineUsers = CaoLiao.models.Users.findOnlineUserFromList(_.pluck(agents, 'username'));
...
CaoLiao.models.LivechatDepartmentAgents = new LivechatDepartmentAgents();
