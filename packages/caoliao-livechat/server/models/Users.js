 ...
 */
CaoLiao.models.Users.setOperator = function(_id, operator) {
	var update = {
		$set: {
			operator: operator
		}
 ...
 * @return
 */
CaoLiao.models.Users.findOnlineAgents = function() {
	var query = {
 ...
 * @return
 */
CaoLiao.models.Users.findOnlineUserFromList = function(userList) {
	var query = {
		statusConnection: { $ne: 'offline' },
		statusLivechat: 'available',
		roles: 'livechat-agent',
 ...
 */
CaoLiao.models.Users.getNextAgent = function() {
	var query = {
		statusConnection: { $ne: 'offline' },
		statusLivechat: 'available',
		roles: 'livechat-agent'
 ...
 */
CaoLiao.models.Users.getVisitorByToken = function(token, options) {
	var query = {
		'profile.guest': true,
		'profile.token': token
	};
 ...
 * @param {string} token - Visitor token
 */
CaoLiao.models.Users.findVisitorByToken = function(token) {
	var query = {
		'profile.guest': true,
		'profile.token': token
	};
 ...
 * @param {string} token - Visitor token
 */
CaoLiao.models.Users.setLivechatStatus = function(userId, status) {
	let query = {
		'_id': userId
	};
...
CaoLiao.models.Users.updateLivechatDataByToken = function(token, key, value) {
	const query = {
		'profile.token': token
	};
 ...
 * @return {object} User from db
 */
CaoLiao.models.Users.findOneVisitorByPhone = function(phone) {
	const query = {
 ...
 */
CaoLiao.models.Users.getNextVisitorUsername = function() {
