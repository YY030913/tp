...
Meteor.loginWithCas = function(options, callback) {
	...
	var login_url = CaoLiao.settings.get('CAS_login_url');
	var popup_width = CaoLiao.settings.get('CAS_popup_width');
	var popup_height = CaoLiao.settings.get('CAS_popup_height');
