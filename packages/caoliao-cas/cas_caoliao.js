...
Meteor.startup(function() {
	CaoLiao.settings.addGroup('CAS', function() {
...
function updateServices(/*record*/) {
	...
	timer = Meteor.setTimeout(function() {
		var data = {
			...
			enabled:          CaoLiao.settings.get('CAS_enabled'),
			base_url:         CaoLiao.settings.get('CAS_base_url'),
			login_url:        CaoLiao.settings.get('CAS_login_url'),
			// caoliao Visuals
			buttonLabelText:  CaoLiao.settings.get('CAS_button_label_text'),
			buttonLabelColor: CaoLiao.settings.get('CAS_button_label_color'),
			buttonColor:      CaoLiao.settings.get('CAS_button_color'),
			width:            CaoLiao.settings.get('CAS_popup_width'),
			height:           CaoLiao.settings.get('CAS_popup_height'),
			autoclose:        CaoLiao.settings.get('CAS_autoclose')
		};
