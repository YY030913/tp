...
Accounts.registerLoginHandler('ldap', function(loginRequest) {
	...
	if (CaoLiao.settings.get('LDAP_Username_Field') !== '') {
	...
	} else if (CaoLiao.settings.get('LDAP_Default_Domain') !== '') {
		userObject.email = username + '@' + CaoLiao.settings.get('LDAP_Default_Domain');
	} else {
