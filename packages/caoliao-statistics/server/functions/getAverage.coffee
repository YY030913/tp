CaoLiao.statistics.getAverage = ->
	...
	result = CaoLiao.models.Statistics.model.mapReduce(m, r, { finalize: f, out: "caoliao_mr_statistics" })
	statistics = CaoLiao.models.MRStatistics.find().fetch()
	return statistics
