Meteor.startup ->
	...
	CaoLiao.callbacks.add 'streamMessage', roomSettingsChangedCallback, CaoLiao.callbacks.priority.HIGH
	...
	CaoLiao.callbacks.add 'streamMessage', roomNameChangedCallback, CaoLiao.callbacks.priority.HIGH
