Template.userEdit.helpers
	canEditOrAdd: ->
		return (Template.instance().user and CaoLiao.authz.hasAtLeastOnePermission('edit-other-user-info')) or (not Template.instance().user and CaoLiao.authz.hasAtLeastOnePermission('create-user'))
	...
	role: ->
		return CaoLiao.models.Roles.find({}, { sort: { description: 1, _id: 1 } })
