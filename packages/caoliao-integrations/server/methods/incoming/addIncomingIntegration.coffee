Meteor.methods
	addIncomingIntegration: (integration) ->
		if (not CaoLiao.authz.hasPermission @userId, 'manage-integrations') and (not CaoLiao.authz.hasPermission @userId, 'manage-own-integrations')
		...
		CaoLiao.models.Roles.addUserRoles user._id, 'bot'
