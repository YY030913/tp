...
class Katex
	...
	# Takes a caoliao message and renders latex in its content
...
CaoLiao.katex = new Katex

cb = CaoLiao.katex.render_message.bind(CaoLiao.katex)
CaoLiao.callbacks.add 'renderMessage', cb

if Meteor.isClient
	Blaze.registerHelper 'CaoLiaoKatex', (text) ->
		return CaoLiao.katex.render_message text
