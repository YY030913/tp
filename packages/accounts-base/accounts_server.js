...
function cloneAttemptWithConnection(connection, attempt) {
  // console.log("cloneAttemptWithConnection",arguments);
  var clonedAttempt = EJSON.clone(attempt);
  clonedAttempt.connection = connection;
  // console.log("clonedAttempt",clonedAttempt);
...
Ap._loginUser = function (methodInvocation, userId, stampedLoginToken) {
  ...
  // console.log("_loginUser",arguments);
...
Ap._attemptLogin = function (
  ...
  // console.log("_attemptLogin",arguments);
...
Ap._initServerMethods = function () {
  ...
  var accounts = this;
  // console.log("_initServerMethods");
  ...
  methods.login = function (options) {
    // console.log("methods.login",arguments);
    var self = this;
...
Ap._initServerPublications = function () {
  // console.log("_initServerPublications")
  var accounts = this;
...
function setupDefaultLoginHandlers(accounts) {
  // console.log("setupDefaultLoginHandlers",arguments);
