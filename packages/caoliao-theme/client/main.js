SlideTab = function(container, options) {
...
SlideTab.prototype = {
	...
	resetHeight: function() {
		...
		// style.height = ($("body").height() - $(".fixed-title").height() - $(".nav").height() - $(".bar").height()) + "px";//$(this.container.children[this.currentIndex])[0].scrollHeight + "px";
		// console.log(this.container.children[this.currentIndex].height);
		// console.log($(this.container.children[this.currentIndex]));
		// console.log(this.container.children[this.currentIndex].offsetHeight);
		// console.log($(this.container.children[this.currentIndex])[1].scrollHeight);
		// console.log($("body").height() - $(".fixed-title").height());
		// console.log($("body").height() - $(".fixed-title").height() - $(".nav").height());
		// console.log($("body").height() - $(".fixed-title").height() - $(".nav").height() - $(".bar").height());
		// console.log($("body").height()-$(".fixed-title").height()-$(".nav").height()-$(".bar").height());
