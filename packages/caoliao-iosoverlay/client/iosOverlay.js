...
! function(e) {
	...
	var iosOverlay = function(params) {
		...
		var create = (function() {
			...
			maskDOM.appendChild(overlayDOM);
			if (params.parentEl) {
				document.getElementById(params.parentEl).appendChild(maskDOM);
			} else {
		...
		var destroy = function() {
			if (params.parentEl) {
				document.getElementById(params.parentEl).removeChild(maskDOM);
			} else {
