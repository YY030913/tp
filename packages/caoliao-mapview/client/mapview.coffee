...
class MapView
	constructor: (message) ->
		...
		mv_enabled = CaoLiao.settings.get 'MapView_Enabled'
		mv_googlekey = CaoLiao.settings.get 'MapView_GMapsAPIKey'
...
CaoLiao.callbacks.add 'renderMessage', MapView, CaoLiao.callbacks.priority.HIGH
