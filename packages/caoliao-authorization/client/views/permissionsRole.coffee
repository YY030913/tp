Template.permissionsRole.helpers
	role: ->
		return CaoLiao.models.Roles.findOne({ _id: FlowRouter.getParam('name') }) or {}
...
Template.permissionsRole.onCreated ->
	...
	@autorun =>
		...
		@usersInRole.set(CaoLiao.models.Roles.findUsersInRole(FlowRouter.getParam('name'), @searchRoom.get(), { sort: { username: 1 } }))
