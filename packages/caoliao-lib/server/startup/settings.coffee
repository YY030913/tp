...
if not CaoLiao.models.Settings.findOneById 'uniqueID'
	CaoLiao.models.Settings.createWithIdAndValue 'uniqueID', process.env.DEPLOYMENT_ID or Random.id()

CaoLiao.settings.addGroup 'Accounts', ->
	@add 'Accounts_AllowshorCountryChange', true, { type: 'boolean', public: true, enableQuery: { _id: 'Accounts_AllowshorCountryChange', value: true } }
	...
	@add 'Accounts_AllowUserIntroductionChange', true, { type: 'boolean', public: true }
...
CaoLiao.settings.addGroup 'OAuth', ->
...
CaoLiao.settings.addGroup 'General', ->
	#"http://127.0.0.1:3000" __meteor_runtime_config__?.ROOT_URL ||  https://caoliao.net.cn
	@add 'Site_Url', "https://caoliao.net.cn", { type: 'string', i18nDescription: 'Site_Url_Description', public: true }
	@add 'Site_Name', 'CaoLiao', { type: 'string', public: true }
	@add 'Language', 'zh-CN', { type: 'language', public: true }
	...
	@section 'UTF8', ->
		@add 'UTF8_Long_Names_And_Introduction_MaxLength', '64', { type: 'int', public: true, i18nDescription: 'UTF8_Long_Names_And_Introduction_MaxLength'}
		@add 'UTF8_Long_Names_And_Introduction_MinLength', '2', { type: 'int', public: true, i18nDescription: 'UTF8_Long_Names_And_Introduction_MinLength'}
...
CaoLiao.settings.addGroup 'Email', ->
	...
	@section 'SMTP', ->
		@add 'SMTP_Host', 'smtp.163.com', { type: 'string', env: true, i18nLabel: 'Host' }
		@add 'SMTP_Port', '465', { type: 'string', env: true, i18nLabel: 'Port' }
		@add 'SMTP_Username', 'hvhvhwhw_xd', { type: 'string', env: true, i18nLabel: 'Username' }
		@add 'SMTP_Password', '2224225a', { type: 'password', env: true, i18nLabel: 'Password' }
		@add 'From_Email', 'hvhvhwhw_xd@163.com', { type: 'string', placeholder: 'email@domain' }
...
CaoLiao.settings.addGroup 'Message', ->
	...
	@add 'Message_ShowFormattingTips', false, { type: 'boolean', public: true }
	...
	@add 'Message_AllowAttachmentDownload:', false, { type: 'boolean', public: true }


CaoLiao.settings.addGroup 'Meta', ->
...
CaoLiao.settings.addGroup 'Push', ->
	@add 'Push_debug', true, { type: 'boolean', public: true }
	@add 'Push_enable', true, { type: 'boolean', public: true }
	@add 'Push_enable_gateway', true, { type: 'boolean' }
	@add 'Push_gateway', 'https://caoliao.net.cn', { type: 'string' }#https://caoliao.net.cn
...
CaoLiao.settings.addGroup 'Layout', ->
	...
	@section 'Content', ->
		...
		@add 'Layout_Home_Body', 'Welcome to CaoLiao <br> Go to APP SETTINGS -> Layout to customize this intro.', { type: 'code', code: 'text/html', multiline: true, public: true }
	...
	@section 'Custom Scripts', ->
		@add 'Custom_Script_Logged_Out', '//', { type: 'code', multiline: true, public: true }
...
CaoLiao.settings.addGroup 'Logs', ->
...
Meteor.startup ->
	CaoLiao.models.Settings.update({ ts: { $lt: CaoLiao.settings.ts }, persistent: { $ne: true } }, { $set: { hidden: true } }, { multi: true })
