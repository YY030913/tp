CaoLiao.roomTypes = new class
	roomTypesOrder = []
	roomTypes = {}
	mainOrder = 1

	### Adds a room type to app
	@param identifier An identifier to the room type. If a real room, MUST BE the same of `db.caoliao_room.t` field, if not, can be null
