...
CaoLiao.callbacks.add 'beforeSaveMessage', Spotify.transform, CaoLiao.callbacks.priority.LOW
CaoLiao.callbacks.add 'renderMessage', Spotify.render
CaoLiao.Spotify = Spotify
