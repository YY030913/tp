...
# 	class ExampleImporter extends CaoLiao.importTool._baseImporter
#		constructor: ->
...
Importer.Base = class Importer.Base
	...
	# @param [Object] user the CaoLiao user
	# @param [Object] room the CaoLiao room
			...
			if fileId
				Meteor.fileStore.write stream, fileId, (err, file) ->
					if err
						...
						CaoLiao.sendMessage user, msg, room
			else
